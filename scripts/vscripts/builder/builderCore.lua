...
function Builder:CreateTower(playerID, owner, position, caster)
	...
	--local generatedName = tostring(Random:GenerateWardName()) --Original
	local generatedName = tostring(Random:GenerateWardName(Builder:TableLength(self.RoundTowers[playerID])))
...
function Builder:CheckIfMergeable(playerID)
    ...
    for key, tower in pairs(self.RoundTowers[playerID]) do
        ...
        print("TESTING MERGES INTO", mergesInto)
